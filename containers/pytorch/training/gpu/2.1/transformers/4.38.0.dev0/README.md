...
#### Method 1: Running the notebook locally
...
#### Method 2: Pushing the image to the Google Cloud Artifact registry and running the notebook on Vertex AI Workbench
...
copy the [golden-gate-finetuning-clm-lora-sft.ipynb](https://github.com/huggingface/Google-Cloud-Containers/tree/add-example-notebook/examples/vertex-ai/golden-gate-finetuning-clm-lora-sft.ipynb) Notebook to the Vertex AI Workbench and test the model. 
